# raftkvstore
raftkvstore is a modified version of [raftexample](https://github.com/etcd-io/etcd/tree/main/contrib/raftexample). The following are the original README contents.
